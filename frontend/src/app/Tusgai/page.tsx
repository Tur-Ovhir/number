...
const Tusgai =()=> {
  ...
  const filteredData = data.filter(
    (item) =>
      String(item.number).includes(searchTerm) || item.name.includes(searchTerm)
  );
  ...
  return (
    <div className="flex justify-center items-center mt-48">
      <div className="flex flex-col gap-3">
        <h1 className="font-bold">Тусгай анги</h1>
